...
def nst_apply(key: str, sorted_image: List[str], img: UploadedFile = File(...)) -> List[str]:
    ...
    for j,i in enumerate(sorted_list):
        if i == 'paint1.jpg':
            link = 'https://deepjerry.s3.ap-northeast-2.amazonaws.com/paint1.jpg'
        elif i == 'paint2.jpg':
            link = 'https://deepjerry.s3.ap-northeast-2.amazonaws.com/paint2.jpg'
        elif i == 'paint3.jpg':
            link = 'https://deepjerry.s3.ap-northeast-2.amazonaws.com/paint3.jpg'
        elif i == 'paint4.jpg':
            link = 'https://deepjerry.s3.ap-northeast-2.amazonaws.com/paint4.jpg'
        else:
            link = 'https://deepjerry.s3.ap-northeast-2.amazonaws.com/paint8.jpg'
